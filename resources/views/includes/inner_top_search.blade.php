@push('scripts')
	...
	@endpush
<div class="customPageSearch" id="myHeader">
	<div class="container-fluid">
		<div class="s131">
			<form>
				<div class="inner-form">
					<div class="input-field first-wrap">
						<input id="search" type="text" placeholder="Enter key skills or Job title" />
					</div>
		...
		<div class="row searchFilter">
			...
			<div class="col-md-2">
				<select class="form-control form-select form-select-sm" id="searchFiltrExpertise" multiple="multiple" aria-label=".form-select-sm example">
...
<script type="text/javascript">
	var selectTwoCon, i;
	$("#searchFilterSector").select2({
		placeholder: "Sector Filter",
		allowClear: true,
		customClass: "Myselectbox"
	});
	$("#searchFiltrExpertise").select2({
		placeholder: "Expertise Filter",
		allowClear: true
	});
	$("#searchFilterLan").select2({
		placeholder: "Language Filter",
		allowClear: true
	});
	selectTwoCon = document.querySelectorAll('.select2-container');
	for ( i = 0; i < selectTwoCon.length; i++) {
		selectTwoCon[i].classList.add('myselectbox');
	}
...
var searchCon, container, searchConOffset, headerContainer, headerConOffset,
	dropDownButtons, i;

container = document.querySelector('.container-fluid');
searchCon = document.querySelector("#myHeader");
searchConOffset = searchCon.offsetTop;
headerContainer = document.querySelector('.header');
headerConOffset = headerContainer.offsetTop;
dropDownButtons = document.querySelectorAll('.demo');

for ( i=0; i<dropDownButtons.length; i++) {
	dropDownButtons[i].addEventListener('click',custToggleButtons.bind(this));
}

function custToggleButtons() {
console.log("worminf");
}

function myFunction() {

  if (window.pageYOffset > headerConOffset) {
    searchCon.classList.add("sticky");
	// headerContainer.classList.add("sticky");
	// searchCon.classList.remove('pageSearchMargin');
	// container.classList.remove("container-fluid");
  } else {
    searchCon.classList.remove("sticky");
	// headerContainer.classList.remove("sticky");
	// searchCon.classList.add('pageSearchMargin');
