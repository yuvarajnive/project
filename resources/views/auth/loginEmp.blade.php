                ...
                <div class="userccount">
                    <div class="userbtns">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item"><a class="nav-link {{($c_or_e == 'employer')? 'active':'active'}}" data-toggle="tab" href="#employer" aria-expanded="false">{{__('Employer')}}</a></li>
                        </ul>
                    </div>
                    <div class="tab-content">
                        <div id="employer" class="formpanel tab-pane fade {{($c_or_e == 'employer')? 'active':'active'}}">
