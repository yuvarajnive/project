                        ...
                        <li id="job_li_{{$job->id}}">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4">                
                                    ...
                                    <div class="listbtn"><a href="{{route('list.hired.users', [$job->id])}}">{{__('List Hired Candidates')}}</a></div>
                                    <div class="listbtn"><a href="{{route('rejected-users', [$job->id])}}">{{__('List Rejected Candidates')}}</a></div>
