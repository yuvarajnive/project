...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'major_subject') !!}">
        {!! Form::label('major_subject', 'Expertise', ['class' => 'bold']) !!}
        {!! Form::text('major_subject', null, array('class'=>'form-control', 'id'=>'major_subject', 'placeholder'=>'Expertise', 'dir'=>$direction)) !!}
